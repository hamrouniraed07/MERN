...
import { initialState, todoReducer } from '../reducers/todoReducer'; // chemin selon ton projet
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <strong>Total :</strong> {state.todos.length} | <strong>Complétées :</strong> {state.todos.filter(t => t.completed).length}
      </div>
    </div>
  );
}
